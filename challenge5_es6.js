...
const allParks = [
  new Park('Victoria Park', 1920, 0.2, 215),
  new Park('Hyde Park', 1925, 2.9, 3541),
  new Park('Roma Parklands', 1928, 0.4, 949)
]

const allStreets = [
  new Street('Endeavour Boulevard', 2010, 2.7, 2),
  new Street('Discovery Drive', 2012, 1.1, 4),
  new Street('Bounty Boulevard', 2014, 2.5, 5),
  new Street('Chalk Circuit', 2016, 0.8)
]
